...
mainPanel::mainPanel( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style ) : wxPanel( parent, id, pos, size, style )
{
	...
	fgSizer300->Add( fgSizer248, 0, 0, 5 );
        ...
        cmbLmsDevice = new wxChoice(this, ID_LMS_CHOICE, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_LMS_CHOICE"));
        cmbLmsDevice->SetSelection(cmbLmsDevice->Append(_T("LMS 1")));
        cmbLmsDevice->Append(_T("LMS 2"));
        fgSizer300->Add( cmbLmsDevice, 0, 0, 5 );
	...
	tabsNotebook->Connect( wxEVT_COMMAND_NOTEBOOK_PAGE_CHANGED, wxNotebookEventHandler( mainPanel::Onnotebook_modulesPageChanged ), NULL, this );
        cmbLmsDevice->Connect( wxEVT_COMMAND_CHOICE_SELECTED, wxCommandEventHandler( mainPanel::OnLmsDeviceSelect ), NULL, this );
}
